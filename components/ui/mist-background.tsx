...
const MistBackground = ({ className }: { className?: string }) => {
  return (
    <div className={cn("absolute inset-0 z-0 pointer-events-none overflow-hidden", className)}>
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] rounded-full bg-cyan-300/30 dark:bg-cyan-900/20 blur-[120px] animate-mist-flow-1 mix-blend-multiply dark:mix-blend-screen" />
      <div className="absolute top-[10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-teal-300/30 dark:bg-teal-900/20 blur-[100px] animate-mist-flow-2 mix-blend-multiply dark:mix-blend-screen" />
      <div className="absolute bottom-[-20%] left-[10%] w-[60%] h-[60%] rounded-full bg-emerald-300/30 dark:bg-emerald-900/10 blur-[140px] animate-mist-flow-3 mix-blend-multiply dark:mix-blend-screen" />
